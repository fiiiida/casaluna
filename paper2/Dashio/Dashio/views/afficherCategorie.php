        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="../buttons.html">Produits</a></li>
              <li class="active"><a href="../ajcategorie.html">Categories</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
...
<h4><i class="fa fa-angle-right"></i>Les categories:</h4>
