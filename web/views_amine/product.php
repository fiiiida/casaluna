			...
			<div class="col-md-4 text-center animate-box">
					<div class="product1">
						<div class="product1-grid" style="background-image:url(<?php echo $repertoire.$image_prod; ?>);">
							<div class="inner">
								<p>
									<a href="ajouterpanier.php?id=<?php echo $row['id_prod']; ?>"  class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="details_product.php?id_prod=<?PHP echo $row['id_prod']; ?> " class="icon"><i class="icon-eye"></i></a>
								</p>
							</div>
						</div>
						<div class="desc">
