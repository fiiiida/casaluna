        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="../buttons.html">Ajouter produit</a></li>
...
if (isset($_GET['idc'])){
  ...
  foreach($result as $row){
    $idc=$row['idc'];
    $id_cat=$row['id_cat'];
    $leb_cat1=$row['leb_cat1'];
?>
            <h3></h3>
<form name="p" >
<div id='cssmenu'>
<ul>
   <li><a href='../ajcategorie.html'>Ajout</a></li>
   <li><a href='afficherCategorie.php'>Affichage</a></li>
...
<div>
     <p>
       <label>Nouvelle lebelle:</label><br />
       <input type="text" name="leb_cat1" value="<?PHP echo $leb_cat1 ?>">
   </p>
    </div>
    <br>
<div>
<div>
    <label class="control-label">Nouvelle id: </label>
    <div class="controls">
   <input type="text" name="id_cat" id="reff" value="<?PHP echo $id_cat ?>">
    </div>
    <p>
</div>
...
if (isset($_POST['modifier'])){
	$categorie=new Categorie($_POST['idc'],$_POST['id_cat'],$_POST['leb_cat1']);
