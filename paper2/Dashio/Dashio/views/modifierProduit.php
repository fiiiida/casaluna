...
<div id='cssmenu'>
<ul>
   <li><a href='buttons.html'>Ajout</a></li>
   <li><a href='afficherProduit.php'>Affichage</a></li>
...
<div>
    ...
    <div class="controls">
   <input type="hidden" name="idp" id="reff" value="<?PHP echo $idp ?>">
    </div>
    <p>
</div>
<div>
    ...
    <div class="controls">
   <input type="text" name="lib_prod" value="<?PHP echo $lib_prod ?>">
    </div>
    <p>
</div>
<div>
	...
	<input type="number" name="id_prod" value="<?PHP echo $id_prod ?>">
   </p>
    </div>
...
<div>
  <label>Quantite:    </label>
	<input type="number" name="qte_prod" value="<?PHP echo $qte_prod ?>">
</div>
<div>
  <label>Image:    </label>
...
if (isset($_POST['modifier'])){
	$produit=new Produit($_POST['idp'],$_POST['lib_prod'],$_POST['id_prod'],$_POST['id'],$_POST['prix'],$_POST['qte_prod'],$_POST['image'],$_POST['description']);
